...
const DownloadButton = () => {
    return (
        <div className="flex justify-center w-full">
            <a href='./CV - Leandro Esteban Villalba.pdf' download className="download-button transform active:scale-95 bg-sky-600 hover:bg-sky-500 text-white px-10 py-3 rounded-lg font-bold tracking-widest w-full text-center shadow-lg transition-all duration-300">
                <div className="flex justify-center items-center relative">
                    <div className="svg-container mr-2">

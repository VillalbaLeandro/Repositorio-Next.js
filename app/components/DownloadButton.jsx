    ...
    return (
        <div>
            <div className="flex justify-center mt-5">
                <a href='./CV - Leandro Esteban Villalba.pdf' download className="download-button transform active:scale-95 bg-blue-500 hover:bg-blue-400 text-white px-10 py-3 rounded-lg font-bold tracking-widest w-full">

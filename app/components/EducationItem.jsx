...
const EducationItem = ({ period, institution, title, certificatedLink, certificatedImage }) => {
    ...
    return (
        <li className="mb-6 ms-4">
            ...
            <time className="mb-1 ml-1 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">{period}</time>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white ">{institution}</h3>
            <p className='text-gray-800 text-sm mb-2 dark:text-gray-300'>{title}</p>
            {certificatedLink
                &&
                <div className=''>

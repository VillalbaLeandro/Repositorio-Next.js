    ...
    >
      <div className="container mx-auto px-5 py-10">
        <div className="mb-12 flex w-full flex-col text-center">
          ...
          <p className="mx-auto text-base leading-relaxed lg:w-2/3 dark:text-gray-800 dark:font-semibold">No dudes en contactarme. ¿Tienes alguna pregunta, sugerencia o propuesta de colaboración? Estoy aquí para escucharte y ansioso por iniciar una conversación contigo. Tu opinión es valiosa para mí, así que por favor, no dudes en ponerte en contacto.
          </p>
        </div>

...
const SkillIcon = ({ tip, children }) => (
    <div data-tip={tip} className="tooltip">
        <div className="flex relative *:relative *:m-auto size-16 sm:size-20 rounded-xl bg-white dark:bg-gray-800/50 border border-gray-100 dark:border-indigo-500/30 shadow-[0_4px_12px_rgba(0,0,0,0.08)] dark:shadow-indigo-500/10 before:rounded-[11px] before:absolute before:inset-0 before:bg-gradient-to-b before:from-transparent before:to-transparent dark:before:from-indigo-600/50 dark:before:to-indigo-900/10">
            {children}
        </div>
    </div>
);
    ...
    return (
        <section id="skills" className='p-4 sm:p-6 z-10'>
            ...
            <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-3">
                    <SkillIcon tip="Node.js">
                        <img loading="lazy" src='./img/skills/node-logo.png' width={25} height={25} alt='Node.js' />
                    </SkillIcon>
                    <SkillIcon tip="Express">
                        <img loading="lazy" src='./img/skills/express-logo.png' width={50} height={50} alt='Express' />
                    </SkillIcon>
                    <SkillIcon tip="PHP">
                        <img loading="lazy" src='./img/skills/php-logo.png' width={50} height={50} alt='PHP' />
                    </SkillIcon>
                    <SkillIcon tip="Laravel">
                        <img loading="lazy" src='./img/skills/laravel-logo.png' width={30} height={30} alt='Laravel' />
                    </SkillIcon>
                </div>
            </div>
            ...
            <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-3">
                    <SkillIcon tip="MySQL">
                        <img loading="lazy" src='./img/skills/Mysql-logo.png' width={50} height={50} alt='MySQL' />
                    </SkillIcon>
                    <SkillIcon tip="MongoDB">
                        <img loading="lazy" src='./img/skills/mongodb-logo.png' width={50} height={50} alt='MongoDB' />
                    </SkillIcon>
                    <SkillIcon tip="SQL">
                        <img loading="lazy" src='./img/skills/sql-logo.png' width={50} height={50} alt='SQL' />
                    </SkillIcon>
                </div>
            </div>

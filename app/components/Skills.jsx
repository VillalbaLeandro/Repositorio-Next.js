...
const Skills = () => {
    ...
    const allSkills = [
        ...
        { tip: "Angular", content: <img loading="lazy" src='/img/skills/angular-logo.webp' width={50} height={50} alt='Angular' />, category: "Frontend" },
        { tip: "Ionic", content: <img loading="lazy" src='/img/skills/ionic-logo.webp' width={50} height={50} alt='Ionic' />, category: "Mobile" },
        ...
        { tip: "TypeScript", content: <img loading="lazy" src='/img/skills/ts-logo.webp' width={50} height={50} alt='TypeScript' />, category: "Frontend" },
        { tip: "HTML", content: <img loading="lazy" src='/img/skills/html-logo.webp' width={25} height={25} alt='HTML' />, category: "Frontend" },
        ...
        { tip: "Node.js", content: <img loading="lazy" src='/img/skills/node-logo.webp' width={25} height={25} alt='Node.js' />, category: "Backend" },
        { tip: "Express", content: <img loading="lazy" src='/img/skills/express-logo.webp' width={50} height={50} alt='Express' />, category: "Backend" },
        { tip: "PHP", content: <img loading="lazy" src='/img/skills/php-logo.webp' width={50} height={50} alt='PHP' />, category: "Backend" },
        { tip: "Laravel", content: <img loading="lazy" src='/img/skills/laravel-logo.webp' width={30} height={30} alt='Laravel' />, category: "Backend" },
        { tip: "MySQL", content: <img loading="lazy" src='/img/skills/Mysql-logo.webp' width={50} height={50} alt='MySQL' />, category: "Database" },
        { tip: "PostgreSQL", content: <img loading="lazy" src='/img/skills/postgre-logo.webp' width={50} height={50} alt='PostgreSQL' />, category: "Database" },
        { tip: "Oracle", content: <img loading="lazy" src='/img/skills/oracle-logo.webp' width={50} height={50} alt='Oracle' />, category: "Database" },
        { tip: "SQL", content: <img loading="lazy" src='/img/skills/sql-logo.webp' width={50} height={50} alt='SQL' />, category: "Database" },
        { tip: "Git", content: <img loading="lazy" src='/img/skills/git-logo.webp' width={25} height={25} alt='Git' />, category: "Tools" },
        { tip: "Docker", content: <img loading="lazy" src='/img/skills/docker-logo.webp' width={60} height={60} alt='Docker' />, category: "Tools" },
        { tip: "Vite", content: <img loading="lazy" src='/img/skills/vite-logo.webp' width={50} height={50} alt='Vite' />, category: "Tools" },
        { tip: "Jest", content: <img loading="lazy" src='/img/skills/jest-logo.webp' width={50} height={50} alt='Jest' />, category: "Tools" },
        { tip: "jQuery", content: <img loading="lazy" src='/img/skills/jquery-logo.webp' width={30} height={30} alt='jQuery' />, category: "Frontend" },
        ...
        { tip: "WordPress", content: <img loading="lazy" src='/img/skills/wordpress-logo.webp' width={50} height={50} alt='WordPress' />, category: "Tools" },
        { tip: "React Native", content: <img loading="lazy" src='/img/skills/react-native-logo.webp' width={50} height={50} alt='React Native' />, category: "Mobile" },

...
const Skills = () => {
    ...
    const allSkills = [
        ...
        { tip: "Next.js", content: <img loading="lazy" src='./img/skills/Next.js.png' width={50} height={50} alt='Next.js' />, category: "Frontend" },
        { tip: "Angular", content: <img loading="lazy" src='./img/skills/angular-logo.png' width={50} height={50} alt='Angular' />, category: "Frontend" },
        { tip: "Ionic", content: <img loading="lazy" src='./img/skills/ionic-logo.png' width={50} height={50} alt='Ionic' />, category: "Frontend" },
        ...
        { tip: "MongoDB", content: <img loading="lazy" src='./img/skills/mongodb-logo.png' width={50} height={50} alt='MongoDB' />, category: "Database" },
        ...
        { tip: "React Native", content: <img loading="lazy" src='./img/skills/react-native-logo.png' width={50} height={50} alt='React Native' />, category: "Frontend" },
    ];
    ...
    return (
        <section id="skills" className="p-4 sm:p-6 z-10 w-full overflow-hidden [overflow-x:clip] touch-pan-y">
            ...
            {showList ? (
                ...
                <div className="max-w-6xl mx-auto space-y-8">
                    {Object.entries(skillsByCategory).map(([category, skills]) => (
                        <div key={category}>
                            <h3 className='font-semibold text-lg mb-4 text-indigo-500 dark:text-indigo-400'>{category}</h3>
                            <div className="flex flex-wrap gap-3">
                                {skills.map((skill, index) => (
                                    <SkillIcon key={`${category}-${index}`} tip={skill.tip}>
                                        {skill.content}
                                    </SkillIcon>
                                ))}
                            </div>

            ...
            {repositorioUrl && (
                isPrivate ? (
                    <div className="flex-1 group/button relative flex justify-center">
                        ...
                        <div className="absolute bottom-full mb-2 w-auto max-w-[200px] whitespace-normal text-center px-3 py-1 bg-gray-900 text-white text-[10px] rounded opacity-0 group-hover/button:opacity-100 transition-opacity duration-200 pointer-events-none shadow-lg z-50">
            ...
            {deployUrl && (
                deployUrl === 'private' ? (
                    <div className="flex-1 group/button relative flex justify-center">
                        ...
                        <div className="absolute bottom-full mb-2 w-auto max-w-[200px] whitespace-normal text-center px-3 py-1 bg-gray-900 text-white text-[10px] rounded opacity-0 group-hover/button:opacity-100 transition-opacity duration-200 pointer-events-none shadow-lg z-50">
                            El sitio es privado y no puedo mostrar una demo 🔒
                            <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-900"></div>
                        </div>
                    </div>
                ) : (

...
const AboutMe = () => {
    return (
        <div className='text-center  glass-effect rounded xs:max-w-80 xl:max-w-96 flex flex-col gap-1 mt-28 mb-64 p-10' >
            ...
            <div id='experience' className='icon-scroll md:hidden'></div>
        </div>
    )
}
